...
[![GitHib](https://img.shields.io/badge/-GitHub%20Project-brightgreen.svg?logo=github)](https://github.com/benbarth/hacktoberfest-swag)
...
[![Build Status](https://api.travis-ci.org/benbarth/hacktoberfest-swag.svg?branch=master)](https://travis-ci.org/benbarth/hacktoberfest-swag)
...
| Operation Code | ![Shirt](icons/tshirt-greyscale.png) ![Stickers](icons/stickers-greyscale.png) | "Close 3 issues & get a 👕. Make a pull request & get stickers." | <https://github.com/OperationCode/START_HERE> (Verified 2018) |
